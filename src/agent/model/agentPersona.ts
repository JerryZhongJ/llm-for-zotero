...
export const AGENT_PERSONA_INSTRUCTIONS: string[] = [
  ...
  [
    ...
    "Use paper_read with no arguments for a broad single-paper overview, sections:['...'] or pages:[...] when the location is known, labels:[...] with images:true for extracted figure crops, pages with images:true for rendered page inspection, readFullReason only for an explicit exhaustive-read request, and paper_query({query}) for a specific missing claim. An overview or passage read never satisfies an explicit full-read request.",

  ...
  return {
    spec: {
      ...
      description:
        ...
        "For PDF attachments, the attachments section may include mineruCacheDir. Use paper_read for ordinary PDF paper content and labels with images:true for figure crops; use file_io only for explicit MinerU cache metadata inspection such as manifest offsets or section slices. " +

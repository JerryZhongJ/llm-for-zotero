          ...
          if (isDisallowedMineruSourceImageCacheRead(input.filePath, context)) {
            return {
              content: {
                ...
                filePath: input.filePath,
                error:
                  "MinerU source image caches are not available. Use paper_read({ labels:[...], images:true }) to extract source-PDF figure crops under figure_crops/**.",
              },
              effect: "none",
            };
          }
